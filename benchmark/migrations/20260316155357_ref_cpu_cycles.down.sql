-- Remove reference CPU cycles columns and restore original view

DROP VIEW IF EXISTS measurement_results_view;

ALTER TABLE measurements
    DROP COLUMN IF EXISTS ref_cycles_mean,
    DROP COLUMN IF EXISTS ref_cycles_stddev;

-- Restore the original view without ref_cycles columns
