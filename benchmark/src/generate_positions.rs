...
fn run_embedding_dynamic(
    ...
    match dim {
        2 => run_embedding::<2, ATree<2>>(seed, graph, options, output_path),
        3 => run_embedding::<3, ATree<3>>(seed, graph, options, output_path),
        4 => run_embedding::<4, ATree<4>>(seed, graph, options, output_path),
        5 => run_embedding::<5, ATree<5>>(seed, graph, options, output_path),
        6 => run_embedding::<6, ATree<6>>(seed, graph, options, output_path),
        7 => run_embedding::<7, ATree<7>>(seed, graph, options, output_path),
        8 => run_embedding::<8, ATree<8>>(seed, graph, options, output_path),
        9 => run_embedding::<9, ATree<9>>(seed, graph, options, output_path),
        10 => run_embedding::<10, ATree<10>>(seed, graph, options, output_path),
        11 => run_embedding::<11, ATree<11>>(seed, graph, options, output_path),
        12 => run_embedding::<12, ATree<12>>(seed, graph, options, output_path),
        13 => run_embedding::<13, ATree<13>>(seed, graph, options, output_path),
        14 => run_embedding::<14, ATree<14>>(seed, graph, options, output_path),
        15 => run_embedding::<15, ATree<15>>(seed, graph, options, output_path),
