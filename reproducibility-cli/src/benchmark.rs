...
//         let position_results: Vec<PositionResult> = vec![]; // Placeholder for actual query results

//         let data_directory = std::env::var("DATA_DIRECTORY").unwrap_or(String::from("../data/"));

//         // check if the results exist
//         for result in &position_results {
//             let pos_path: String = result.pos_path.clone();
//             let pos_path = format!("{data_directory}/{}", pos_path);
//             let graph_path: String = result.graph_path.clone();
...
//         let pos_path: String = result.pos_path;
//         let pos_path = format!("{data_directory}/{}", pos_path);
//         let graph_path: String = result.graph_path;
//         let graph_path = format!("{data_directory}/{}", graph_path);
//         let embedding_dim: i32 = result.embedding_dim;
//         let dim_hint: i32 = result.dim_hint;
